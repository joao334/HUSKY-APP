    ...
    const state = {
      ...
      cart:loadJson("husky_cart",{}), orders:[], chatMessages:[], productModal:null,
    ...
    function saveCart(){localStorage.setItem("husky_cart",JSON.stringify(state.cart))}
    function icon(name){
    ...
    (async function boot(){try{initSupabase();await loadProducts();await loadCoupons();render();}catch(e){showFatalError('Erro ao iniciar o app do cliente',e)}})();
